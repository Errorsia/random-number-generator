...
def random_number():
    ...
    if abs(num1) > 10 ** 30 or abs(num2) > 10 ** 30:
...
label1_text2 = "Attention:\n\n请输入一个整数( -10**30 <= n <= 10**30)."
label101 = tk.Label(root, text=label1_text1 + label1_text2, font=45, width=50, height=10)
